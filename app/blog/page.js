  ...
  return (
    ...
    <section class="cs_page_heading cs_style_1 cs_bg_filed_filed cs_heading_bg" data-src="/assets/img/about_heading_bg.jpg">
      <div class="container">
        ...
        <h1 class="cs_page_title mb-0 cs_fs_80 wow fadeInUp">Latest Post</h1>
      </div>
    </section>
          ...
          <div class="col-lg-8">
            <div class="cs_post_1_list">
              <div class="cs_post cs_style_1">
                <a href="/blog-details" class="cs_post_thumb cs_radius_15">
                  <img src="/assets/img/post_1.jpg" alt="Post" class="w-100 cs_radius_15">
                </a>
                <div class="cs_post_info">
                  <div class="cs_post_meta cs_style_1">
                    <span class="cs_posted_by">07 Mar 2025</span>
                    <a href="#" class="cs_post_avatar">Landscape</a>
                  </div>
                  <h2 class="cs_post_title cs_fs_40">
                    <a href="/blog-details">Transform Yard with Expert Landscape Design Services</a>
                  </h2>
                  <div class="cs_post_sub_title">Discover how professional garden landscape design can elevate your outdoor space, create functional areas, and bring your vision to life with expert craftsmanship and personalized solutions.</div>
                  <a href="/blog-details" class="cs_btn cs_style_2 cs_bold cs_heading_color">See More</a>
                </div>
              </div>
              <div class="cs_post cs_style_1">
                <a href="/blog-details" class="cs_post_thumb cs_radius_15">
                  <img src="/assets/img/post_2.jpg" alt="Post" class="w-100 cs_radius_15">
                </a>
                <div class="cs_post_info">
                  <div class="cs_post_meta cs_style_1">
                    <span class="cs_posted_by">04 Mar 2025</span>
                    <a href="#" class="cs_post_avatar">Gardening</a>
                  </div>
                  <h2 class="cs_post_title cs_fs_40">
                    <a href="/blog-details">How a Landscape Design Service Enhances Your Garden's Appeal</a>
                  </h2>
                  <div class="cs_post_sub_title">Learn how a skilled landscape design service can improve your garden’s aesthetics, increase property value, and create a serene environment tailored to your style and needs.</div>
                  <a href="/blog-details" class="cs_btn cs_style_2 cs_bold cs_heading_color">See More</a>
                </div>
              </div>
              <div class="cs_post cs_style_1">
                <a href="/blog-details" class="cs_post_thumb cs_radius_15">
                  <img src="/assets/img/post_3.jpg" alt="Post" class="w-100 cs_radius_15">
                </a>
                <div class="cs_post_info">
                  <div class="cs_post_meta cs_style_1">
                    <span class="cs_posted_by">02 Mar 2024</span>
                    <a href="#" class="cs_post_avatar">Professional</a>
                  </div>
                  <h2 class="cs_post_title cs_fs_40">
                    <a href="/blog-details">Benefits of Hiring a Professional Landscape Designer</a>
                  </h2>
                  <div class="cs_post_sub_title">Explore the advantages of working with a professional designer, including unique designs, better planning, cost efficiency, and enhanced outdoor living spaces for your home or business.</div>
                  <a href="/blog-details" class="cs_btn cs_style_2 cs_bold cs_heading_color">See More</a>
                </div>
              </div>
            </div>
            ...
            <ul class="cs_pagination_box cs_center cs_mp_0">
              <li>
                <a class="cs_pagination_item cs_center active" href="/blog">1</a>
              </li>
              <li>
                <a class="cs_pagination_item cs_center" href="/blog">2</a>
              </li>
              <li>
                <a class="cs_pagination_item cs_center" href="/blog">3</a>
              </li>
              <li>
                <a class="cs_pagination_item cs_center" href="/blog">4</a>
              </li>
              <li>
