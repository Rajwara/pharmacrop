  ...
  <!-- End Preloader -->
    ...
    <section class="cs_page_heading cs_style_1 cs_bg_filed cs_heading_bg" data-src="/assets/img/project_heading_bg.jpg">
      <div class="container">
        ...
        <h1 class="cs_page_title mb-0 cs_fs_80 wow fadeInUp">OUR PROJECTS</h1>
      </div>
    </section>
    ...
    <div class="container">
      ...
      <div class="cs_card cs_style_5">
        <a href="/project-details" class="cs_card_thumb">
          <img src="/assets/img/project_thumb_10.jpg" alt="">
        </a>
        <div class="cs_card_right">
          <h2 class="cs_card_title cs_fs_80 mb-0"><a href="#">EVENING GARDEN</a></h2>
    ...
    <div class="cs_card cs_style_6 cs_bg_filed" data-src="/assets/img/project_thumb_11.jpg">
      <div class="container">
        <div class="cs_card_in">
          <div class="cs_card_left">
            <h2 class="cs_card_title cs_white_color cs_fs_80 mb-0"><a href="/project-details">SECRET GARDEN</a></h2>
            <ul class="cs_card_info_list cs_mp_0">
              <li>
                <p class="mb-0 cs_white_color">YEAR</p>
                <h4 class="mb-0 cs_fs_20 cs_bold cs_white_color">2024</h4>
              </li>
              <li>
                <p class="mb-0 cs_white_color">LOCATION</p>
                <h4 class="mb-0 cs_fs_20 cs_bold cs_white_color">CHARLESTON, SC</h4>
              </li>
              <li>
                <p class="mb-0 cs_white_color">SERVICE</p>
                <h4 class="mb-0 cs_fs_20 cs_bold cs_white_color">PUBLIC GARDEN DESIGN</h4>
              </li>
            </ul>
          </div>
          <div class="cs_card_right">
            <div class="cs_card_text">
              <p class="text-uppercase cs_white_color mb-0">DESCRIPTION</p>
              <p class="cs_fs_20 cs_bold cs_white_color cs_mb_40">Tucked behind an old Japanese estate, this garden design evokes the charm of a hidden garden. The lighting design enhances the feeling of discovery, revealing unexpected beauty at every turn. It's a garden where every night feels like an adventure.</p>
              <p class="text-uppercase cs_white_color mb-0">OUTCOMES</p>
              <p class="cs_fs_20 cs_bold cs_white_color mb-0">The charm of a hidden garden <br>
                Oriental sense of discovery <br>
                Every step feels like an adventure</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="cs_card cs_style_5">
        <a href="/project-details" class="cs_card_thumb">
          <img src="/assets/img/project_thumb_12.jpg" alt="">
        </a>
        <div class="cs_card_right">
          <h2 class="cs_card_title cs_fs_80 mb-0"><a href="/project-details">MINIMALIST GARDEN</a></h2>
          <ul class="cs_card_info_list cs_mp_0">
            <li>
              <p class="mb-0">YEAR</p>
              <h4 class="mb-0 cs_fs_20 cs_bold">2024</h4>
            ...
            <li>
              <p class="mb-0">LOCATION</p>
              <h4 class="mb-0 cs_fs_20 cs_bold">ASHVILLE, NC</h4>
            </li>
            <li>
              <p class="mb-0">SERVICE</p>
              <h4 class="mb-0 cs_fs_20 cs_bold">EVENT GARDEN DESIGN</h4>
            </li>
          </ul>
        </div>
      </div>
        ...
        <div class="cs_slider_wrapper">
          <div class="cs_slide">
            <div class="container">
              <div class="cs_card cs_style_5">
                <a href="/project-details" class="cs_card_thumb">
                  <img src="/assets/img/project_thumb_13.jpg" alt="">
                </a>
                <div class="cs_card_right">
                  <h2 class="cs_card_title cs_fs_80 mb-0"><a href="/project-details">GREEN DISPLAY GARDEN</a></h2>
                  <ul class="cs_card_info_list cs_mp_0">
                    <li>
                      <p class="mb-0">YEAR</p>
                      <h4 class="mb-0 cs_fs_20 cs_bold">2023</h4>
                    </li>
                    <li>
                      <p class="mb-0">LOCATION</p>
                      <h4 class="mb-0 cs_fs_20 cs_bold">BROOKLYN, NY</h4>
                    </li>
                    <li>
                      <p class="mb-0">SERVICE</p>
                      <h4 class="mb-0 cs_fs_20 cs_bold">INDOOR GARDEN DESIGN</h4>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div class="cs_slide">
            <div class="container">
              <div class="cs_card cs_style_5">
                ...
                <div class="cs_card_right">
                  <h2 class="cs_card_title cs_fs_80 mb-0"><a href="/project-details">EVENING GARDEN</a></h2>
                  <ul class="cs_card_info_list cs_mp_0">
                    <li>
                      <p class="mb-0">YEAR</p>
                      <h4 class="mb-0 cs_fs_20 cs_bold">2024</h4>
          ...
          <div class="cs_slide">
            <div class="container">
              <div class="cs_card cs_style_5">
                ...
                <div class="cs_card_right">
                  <h2 class="cs_card_title cs_fs_80 mb-0">GREEN DISPLAY GARDEN</h2>
                  <ul class="cs_card_info_list cs_mp_0">
                    <li>
                      <p class="mb-0">YEAR</p>
                      <h4 class="mb-0 cs_fs_20 cs_bold">2023</h4>
